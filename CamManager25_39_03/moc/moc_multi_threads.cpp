/****************************************************************************
** Meta object code from reading C++ file 'multi_threads.h'
**
...
#error "The header file 'multi_threads.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(3, 29, 3) // "run"
    ...
    "ThreadManager\0dataProcessed\0\0run"
};
...
void ThreadManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ThreadManager::dataProcessed)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ThreadManager::dataProcessed()
{
